...
export const ListDataRadarChart = (
  props: ListDataChartProps<RadarChartItem>,
) => {
  ...
  const handleChangeRadarChart = (columnData: DataDateInColumn) => {
    ...
    const lineChart: ChartData<ChartCustomType.RADAR> = {
      labels: labels,
